                     ...
                     <div class="input-group">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group d-flex">
                        <button name="submit" type="submit" class="btn btn-laranja btn-block m-0 mr-3">Limpar</button>
                        <button name="submit" type="submit" class="btn btn-primary btn-block m-0">Salvar</button>
                       </div>
                      </div>
                     </div>
                   </form>
